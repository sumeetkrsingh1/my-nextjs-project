      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:block">
          <div className="card overflow-hidden animate-fade-in-up">
            ...
            <div className="p-6">
              <h2 className="text-2xl font-bold text-slate-900">Welcome back to Knockes</h2>
              <p className="mt-2 text-slate-700 text-sm">Sign in to manage applications, track financing, and save properties.</p>
              <ul className="mt-4 text-sm text-slate-700 space-y-1">
                <li>• Unified financing hub</li>
                <li>• AI property recommendations</li>
                <li>• Secure partner bank workflows</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-slate-600 mt-2 text-sm">Don’t have an account? <Link className="text-[var(--brand-primary)] font-medium" href="/auth/signup">Create one</Link></p>
            </div>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <Link href="#" className="text-slate-700 hover:text-[var(--brand-primary)]">Forgot password?</Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                onClick={() => login("google.user@demo.com", "google")}
              >
              ...
              <button
                type="button"
                className="btn btn-secondary btn-md w-full"
                onClick={() => login("apple.user@demo.com", "apple")}
              >
                Continue with Apple
              </button>
            </div>
